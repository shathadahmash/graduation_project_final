...
import SupervisorProjectsView from "./SupervisorProjectsView";
import SupervisorGroupsView from "./SupervisorGroupsView";
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] font-sans system-manager-theme" dir="rtl">
      ...
      <SupervisorSidebar
        ...
        pendingApprovalsCount={0} // or whatever value you have 
        onOpenNotifications={() => setIsNotificationsOpen(true)} // ✅ pass this down
      />

      {/* Main */}
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header (تصميم مطابق للمرجع) */}
        <SupervisorHeader
          ...
          // i am adding this for the notif.bar
        ...
        <main className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          {activeTab === "home" && (
            <div className="max-w-7xl mx-auto space-y-10">
              ...
              {/* Optional: Section that shows combined table when needed */}
              {/* إذا تبغيه
يظهر مباشرة تحت الزر، خليه هنا */}
          ...
          {/* لو تبغين زر “المجموعات والمشاريع” يفتح جدول موحد */}
