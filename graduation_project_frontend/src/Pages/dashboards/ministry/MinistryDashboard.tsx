      ...
      >
        <div className="p-6 flex items-center justify-between border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <span className="font-black text-lg tracking-tight">نظام الوزارة</span>
          </div>
          <button
            onClick={() => setIsSidebarOpen(false)}
        ...
        <div className="absolute bottom-8 left-0 right-0 px-6">
          <div className="bg-slate-800/50 p-4 rounded-2xl border border-slate-700/50">
            ...
            <p className="text-sm font-bold text-white">ممثل الوزارة</p>
          </div>
        </div>
      </aside>
        ...
        <header className="bg-[#0E4C92] text-white p-4 shadow-lg">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right hidden md:block">
                ...
                <p className="text-xs opacity-80">ممثل الوزارة</p>
              </div>
